/**
 * VUE CHÂTEAUX - Liste des châteaux avec design moderne.
 * Client component rendu côté serveur (SSR) : le filtre `dept` arrive en prop
 * depuis le Server Component page.tsx — jamais via useSearchParams() (qui
 * ferait basculer toute la page en rendu 100 % navigateur, invisible pour
 * les crawlers IA).
 */
...
interface ChateauxPageViewProps {
  dept?: string;
}

export function ChateauxPageView({ dept }: ChateauxPageViewProps) {
