              ...
              >
                {visibleTestimonials.map((testimonial, index) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    {/* Carte style Google My Business - Format rectangulaire horizontal */}
                    <div
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {/* Badge "Avis Google" */}
                        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full" style={{ background: '#f8f9fa' }}>
                          ...
                          <span style={{ fontSize: '0.75rem', color: '#5f6368', fontWeight: 500 }}>Avis Google</span>
                        </div>
                      </div>
