...
export function FooterLuxe() {
  return (
    <footer className="relative bg-gradient-to-b from-gray-100 via-gray-50 to-white border-t border-gray-200" style={{ paddingTop: '60px', paddingBottom: '30px' }}>
      {/* Glow effect top */}
      ...
      <div className="w-full flex flex-col items-center justify-center px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 max-w-7xl mx-auto w-full" style={{ marginBottom: '45px' }}>
          {/* Colonne 1 - À propos */}
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-sm" style={{ marginBottom: '24px' }}>
          ...
          <div>
            <h3 className="text-gray-900 font-medium text-sm uppercase tracking-wider" style={{ marginBottom: '20px' }}>
              Navigation
            </h3>
          ...
          <div>
            ...
            <ul className="flex flex-col text-sm text-gray-600" style={{ gap: '12px' }}>
        ...
        {/* Ligne de séparation */}
        <div className="border-t border-gray-200 max-w-7xl mx-auto w-full" style={{ paddingTop: '30px' }}>
          <div className="flex flex-col md:flex-row justify-between items-center" style={{ gap: '16px' }}>
            ...
            <div className="flex text-xs" style={{ gap: '24px' }}>
              <Link
