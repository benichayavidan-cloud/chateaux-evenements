...
export const chateaux: Chateau[] = [
  {
    ...
    meetingRooms: 21,
    restaurationText: "Le Social Club — restaurant gastronomique avec terrasse plein sud : Le restaurant principal du domaine propose une cuisine française raffinée signée par une brigade formée aux grandes maisons. La terrasse panoramique orientée plein sud surplombe le parc de 6 hectares et la forêt de Chantilly — un cadre idéal pour vos déjeuners d'affaires en plein air. Capacité de 280 couverts en configuration banquet, le Social Club se transforme le soir en salle de gala pour vos dîners événementiels sous les lustres du château.\n\nPauses café et cocktails — un atout logistique décisif : Entre deux sessions de travail, les pauses gourmandes sont orchestrées dans les salons attenants aux espaces de réunion ou en terrasse à la belle saison. Viennoiseries maison le matin, pause fruitée en milieu de matinée, cocktail déjeunatoire ou dînatoire avec stations live cooking — chaque moment de restauration est pensé comme un accélérateur de networking informel. Les flux sont optimisés pour que vos participants passent de la salle de réunion au buffet en moins de 2 minutes.\n\nMenus sur mesure pour événements d'entreprise : L'équipe de restauration conçoit des menus entièrement personnalisables selon vos exigences : dîner assis gastronomique en 4 services, buffet thématique, cocktail finger food, brunch de clôture dominical ou barbecue champêtre dans le parc. Tous les régimes alimentaires sont pris en charge (végétarien, végan, halal, casher, sans gluten). Pour les séminaires résidentiels, chaque repas est différent — vos participants ne verront jamais deux fois le même menu.\n\nLe Social Bar — cocktails signatures et soirées animées : Le bar iconique du château est le lieu de rendez-vous pour vos soirées d'entreprise. Cocktails signatures créés sur mesure pour votre événement, sélection de vins et champagnes, ambiance lounge avec DJ — c'est ici que se forgent les liens informels qui font la réussite d'un séminaire résidentiel. Privatisable pour vos soirées, le bar prolonge naturellement le dîner dans une atmosphère décontractée.",
    faq: [
      {
  ...
  },
  {
    ...
    meetingRooms: 9,
    restaurationText: "Le Marguerite 1606 — cuisine d'auteur par le chef Jean-Philippe Perol : Le restaurant gastronomique du domaine porte le nom de l'année où la Reine Margot acquit ces terres. Le chef Jean-Philippe Perol y propose une cuisine subtile, fraîche et gourmande aux notes botaniques, sublimant les produits de saison et les récoltes du potager et du verger du domaine. Sa signature : les Bouchées Marguerite, réinterprétation créative de la Bouchée à la Reine au homard, couteaux de mer et fenouil. Cuisine ouverte visible depuis les tables — vos convives assistent au spectacle culinaire. Capacité de 70 couverts en banquet assis ou 100 en cocktail.\n\nLa Terrasse Jardin — dîners avec vue Tour Eiffel : La terrasse extérieure de 100 m² accueille jusqu'à 98 personnes en cocktail dans un cadre exceptionnel : jardin à la française illuminé, arbres centenaires et vue sur la Tour Eiffel en arrière-plan. Pour vos soirées d'été, cocktails dînatoires ou afterworks d'entreprise, c'est un décor que vos participants ne trouveront nulle part ailleurs aux portes de Paris. Accessible directement depuis le restaurant, elle prolonge naturellement le dîner en plein air.\n\nMenus événementiels sur mesure — du petit-déjeuner au gala : L'équipe du chef compose des menus entièrement personnalisés pour vos événements : petit-déjeuner d'affaires avec jus pressés et viennoiseries maison, déjeuner healthy aux inspirations botaniques, dîner gastronomique en 4 ou 5 services, cocktail finger food avec stations live cooking ou brunch dominical de clôture. Les produits du potager et du verger du domaine sont intégrés aux menus selon la saison — un engagement locavore qui résonne avec les politiques RSE de vos entreprises.\n\nLe Monastic — bar à rhum dans une chapelle classée Monument Historique : Installé dans la Chapelle de la Solitude, chapelle néo-gothique désacralisée du XVIIe siècle, Le Monastic est un speakeasy bar unique au monde. Au milieu de 74 statues de disciples et de vitraux restaurés, un bartender expert guide votre dégustation parmi 400 bouteilles de rhum de 35 origines. Privatisable en groupes de 2 à 12 personnes, c'est l'expérience de clôture parfaite après une journée de séminaire — un moment que vos collaborateurs raconteront longtemps.",
    faq: [
      {
  ...
  },
  {
    ...
    meetingRooms: 14,
    restaurationText: "6 restaurants et bars signés Paris Society — une offre culinaire sans équivalent : L'Abbaye des Vaux de Cernay est le seul domaine événementiel d'Île-de-France à proposer 6 lieux de restauration distincts, tous opérés par Paris Society, référence de la gastronomie événementielle parisienne. Cette diversité transforme chaque repas de votre séminaire en une expérience différente — vos participants ne dînent jamais deux fois dans le même cadre ni avec le même concept culinaire.\n\nLe Réfectoire des Moines — dîners de gala sous des voûtes du XIIe siècle : Le joyau gastronomique du domaine. Sous les voûtes monumentales où les moines cisterciens partageaient leurs repas il y a 900 ans, vos dîners de gala prennent une dimension spectaculaire. Jusqu'à 250 convives en banquet dans un cadre que nul centre de congrès ne peut reproduire. Le brunch dominical dans ce même réfectoire est devenu une institution — le format idéal pour clôturer un séminaire résidentiel en beauté.\n\nLes Chasses & La Trattoria — gastronomie française et italienne : Le restaurant Les Chasses propose une cuisine française traditionnelle et élégante dans un cadre raffiné, parfait pour vos déjeuners d'affaires. La Trattoria offre une alternative conviviale avec une cuisine italienne généreuse en atmosphère familiale — idéale pour les dîners décontractés de team building où l'on partage antipasti et pâtes fraîches autour de grandes tablées.\n\nL'Auberge, James' Bar & Betty's Bar — de l'aube au dernier verre : L'Auberge, bistrot à la cuisine généreuse, accueille vos déjeuners sur le pouce entre deux sessions de travail. James' Bar, cœur battant du domaine du matin au soir, orchestre vos pauses café gourmandes et cocktails de networking. Betty's Bar prolonge les soirées dans une ambiance chaleureuse avec cocktails signatures. Pour vos événements, cette diversité de lieux permet de créer un parcours culinaire complet sur 2 ou 3 jours sans jamais lasser vos participants.",
    faq: [
      {
  ...
  },
  {
    ...
    meetingRooms: 12,
    restaurationText: "L'Opéra — restaurant gastronomique du chef Benoist Rambaud : Installé dans l'ancien salon de musique du compositeur Fernand Halphen, L'Opéra est le restaurant gastronomique du château. Le chef Benoist Rambaud y compose une carte qui évolue au fil des saisons et des semaines, sublimant les produits du terroir picard et les circuits courts. Sous les lustres étincelants, avec vue panoramique sur le parc forestier, vos dîners d'entreprise prennent une dimension mémorable. Capacité de 180 couverts en banquet — idéal pour vos soirées de gala après une journée de convention.\n\nLe Stradivarius — bar-restaurant bistronomique dans l'ancienne bibliothèque : Nommé en hommage à l'héritage musical du château, Le Stradivarius occupe l'ancienne bibliothèque avec ses boiseries d'origine, sa cheminée monumentale et son atmosphère de club anglais. Cuisine bistronomique créative le midi, cocktails signatures le soir — c'est le lieu idéal pour vos déjeuners d'affaires décontractés ou vos soirées networking. L'ambiance feutrée, les fauteuils profonds et la collection de livres anciens créent un cadre propice aux échanges informels qui font la réussite d'un séminaire.\n\nLe Patio & les terrasses — pauses gourmandes en pleine nature : Le patio central du centre de conférences et les deux grandes terrasses face à la forêt de Chantilly sont les lieux naturels de vos pauses café, cocktails déjeunatoires et moments de networking. Stations live cooking, buffets thématiques, barbecue en terrasse à la belle saison — chaque pause est un moment de convivialité orchestré pour que vos participants rechargent les batteries entre deux sessions de travail.\n\nMenus sur mesure & ateliers culinaires : L'équipe de restauration conçoit des menus entièrement personnalisés pour chaque événement : petit-déjeuner buffet premium, déjeuner en 3 services, cocktail dînatoire avec stations thématiques, dîner de gala en 5 services ou brunch de clôture. Les ateliers culinaires avec chef — création de plats, pâtisserie, accords mets-vins — sont parmi les activités de team building les plus demandées. Tous les régimes alimentaires sont pris en charge, et l'approvisionnement en circuits courts s'inscrit dans la démarche responsable du domaine.",
    faq: [
      {
