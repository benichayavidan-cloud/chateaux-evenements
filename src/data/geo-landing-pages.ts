...
<h2>Salle de réunion dans les Yvelines : 14 espaces de travail dans un cadre millénaire</h2>
<p>Chercher une salle de réunion dans les Yvelines, c'est souvent choisir entre praticité et caractère. L'abbaye réunit les deux : 14 salles de réunion réparties dans le domaine, du salon intimiste pour un CODIR de 10 personnes au mythique Réfectoire des Moines de 500 m² qui accueille jusqu'à 300 personnes en cocktail. Toutes les configurations sont possibles — plénière, ateliers en sous-commissions, format en U ou théâtre — et un cinéma privé de 48 places complète le dispositif pour vos projections et conventions. À 45 minutes de Paris, chaque salle bénéficie de l'accompagnement technique de l'équipe sur place, et la privatisation garantit une confidentialité totale pour vos réunions stratégiques.</p>`,
    breadcrumb: [
      { name: "Accueil", url: "/" },
...
<p>9 espaces de réunion modulables s'adaptent à tous les formats : du salon board Agastache (50 m², 17 personnes) pour vos CODIR, au restaurant Marguerite 1606 (160 m², 100 en cocktail) pour vos réceptions. La terrasse jardin de 100 m² accueille vos cocktails en plein air face à la Tour Eiffel. Accessible en 4 minutes à pied depuis la station Mairie d'Issy (métro ligne 12), c'est l'adresse privilégiée des entreprises qui exigent confidentialité, standing et accessibilité.</p>`,
  ...
  // ============================================
  {
    ...
    heroImage: "/images/evenement-entreprise-abbaye-vaux-de-cernay-01-abbaye-des-vaux-de-cernay.webp",
